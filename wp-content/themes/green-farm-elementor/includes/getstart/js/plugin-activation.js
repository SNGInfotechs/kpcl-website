jQuery(document).ready(function($) {
    'use strict';
    var this_obj = green_farm_elementor_plugin_activate_plugin;

    $('#wpelemento_importer_editor .plugin-activation-redirect a').addClass('wpi-redirect-to-dashboard');

    $(document).on('click', '.green-farm-elementor-plugin-install', function(event) {
        ...
        wp.updates.installPlugin({
            ...
            success: function(data) {
                ...
                button.removeClass('button-secondary updating-message green-farm-elementor-plugin-install');
                button.addClass('button-primary green-farm-elementor-plugin-activate');
                button.trigger('click');
            },
            error: function(data) {
                jQuery('.green-farm-elementor-recommended-plugins .green-farm-elementor-activation-note').css('display','block');
    ...
    $(document).on('click', '.green-farm-elementor-plugin-activate', function(event) {
